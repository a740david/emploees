...
def get_people_cnt_by_gender(gender: str):
    """
...
def get_company_employees(company_id: int, current_only: bool=False):
    """
...
def get_person_jobs(person_id: int) :
    """
